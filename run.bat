...
Rem ### Below cmd for Testing and R&D Purposes Default browser is chrome
...
Rem ### Below cmd for Firmware Upgrade Test
pytest -v -s -m "fw_upgrade" --html=Reports/report.html/ TestCases --browser chrome
